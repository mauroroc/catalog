...
http://localhost:8000/catalog/jsonCategorias - que permite visualizar o JSON com todas as categorias existentes.
http://localhost:8000/catalog/jsonItens - que permite visualizar o JSON com todas os itens existentes.
